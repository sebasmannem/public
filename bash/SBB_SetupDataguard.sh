...
alter system set log_archive_dest_2='SERVICE="$UNIQUE_S" ASYNC VALID_FOR=(ONLINE_LOGFILE,PRIMARY_ROLE) db_unique_name="$UNIQUE_S"' scope=spfile;
...
DUPLICATE TARGET DATABASE
  ...
  SPFILE
    ...
    SET LOG_ARCHIVE_DEST_2='SERVICE=${UNIQUE_P} ASYNC VALID_FOR=(ONLINE_LOGFILES,PRIMARY_ROLE) DB_UNIQUE_NAME=${UNIQUE_P}'
